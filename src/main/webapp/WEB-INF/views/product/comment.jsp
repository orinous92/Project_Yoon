...
<div class="comment">
	<form id="commentForm" name="commentForm" method="post">
				...
				<table class="table" style="border:2px solid #000000">
					...
					<tr>
						<td>
							...
							<br>
							<div>
								<a href='#' onclick="save_comment('${productVO.pno}')" class="btn pull-right btn-success">등록</a>
							</div>
						</td>
					</tr>
				</table>
		...
		<input type="hidden" id="pno" name="pno" value="${productVO.pno}"/>
	</form>
</div> 
			...
			success: function(data){
				...
				if(data.length > 0){
					...
					if(document.commentListForm.userid.value == data[i].writer){
						...
						html += "<a href=\"comment_delete?comment_no="+data[i].comment_no+"&pno="+data[i].pno+"\">삭제</a></td></tr></table>";
					}
						html += "</div>";
					}
				} else {
