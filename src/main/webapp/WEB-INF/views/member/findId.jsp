			...
			<section id="content">
				<div class="finduser-nav" style="text-align:center; margin-bottom: 30px;">
					<ul class="nav nav-pills">
						...
						<li role="presentation"><a href="find_pwd">비밀번호 찾기</a></li>
					</ul>
				</div>
				<div class="jumbotron" style="padding-top:20px;">
						<form method="post" action="" name="findId" id="findId">
							...
							<div class="form-group" style="margin-top:60px;">
								<input type="button" class="btn btn-primary form-control" value="아이디 찾기" onclick="findMemberId()">
							</div>
						</form>
					<script type="text/javascript">
						function findMemberId(){
							if(document.findId.username.value == ""){
								...
								document.findId.action = "find_id"; // 요청 문자열
